...
class Instruction
{
    ...
    {
        Assert::oneOf($type, [self::TYPE_ATTR, self::TYPE_ATTRS, self::TYPE_LINK, self::TYPE_LINKS, self::TYPE_TEXT, self::TYPE_TEXTS]);
        Assert::false((($type === self::TYPE_ATTR || $type === self::TYPE_ATTRS) && ($attribute === null)), 'When extracting by attribute(s) the "attribute" argument must be specified.');
